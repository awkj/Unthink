import { CheckIcon, PlusIcon } from "@/ui/components/icons"
...
export const TagEditorOverlay: React.FC = () => {
  ...
  const controller: TagEditorOverlayController | null = workbenchOverlayService.getOverlay(OverlayEnum.desktopTagEditor)
