...
export const desktopStyles = {
  ...
  SidebarPrimaryMenuSpacing: /*tw*/ "pt-3.5",
  SidebarInboxMenuItem: /*tw*/ "mb-3",
  SidebarLogbookMenuItem: /*tw*/ "mt-3",
  SidebarMenuItem:
    /*tw*/ "h-7 px-2 flex rounded-lg text-sm leading-5 items-center gap-2 group transition-colors font-medium",
  SidebarMenuItemActive: /*tw*/ "bg-sidebar-active text-t1 font-semibold",
  SidebarMenuItemInactive: /*tw*/ "text-t1 hover:bg-bg3",
  SidebarMenuItemIcon: /*tw*/ "size-4.5 flex items-center justify-center flex-shrink-0",
  SidebarMenuItemIconSvg: /*tw*/ "size-4.5",
  SidebarMenuItemLabel: /*tw*/ "flex-1 truncate min-w-0 tracking-[-0.01em]",
  ...
  SidebarMenuDivider: /*tw*/ "h-3",

  SidebarProjectAreaList: /*tw*/ "flex-1 overflow-y-auto flex flex-col px-3.5 pt-3 pb-2",
  ...
  EntityHeaderMainRow: /*tw*/ "min-h-16 flex items-start justify-between px-10 pr-4",
  EntityHeaderMainRowDetail: /*tw*/ "!px-3",
  EntityHeaderContentWrapper: /*tw*/ "flex items-start gap-3 flex-1 min-w-0",
  EntityHeaderIconContainer: /*tw*/ "size-6 flex-shrink-0 flex items-center justify-center text-t2 mt-5",
  EntityHeaderIconContainerDetail: /*tw*/ "!h-5 !w-4 !mt-3",
  EntityHeaderIconButton: /*tw*/ "size-full flex items-center justify-center",
  EntityHeaderIconSvg: /*tw*/ "size-6",
  EntityHeaderIconSvgDetail: /*tw*/ "!size-4",
  EntityHeaderEditableTextArea:
    /*tw*/ "flex-1 min-w-0 text-xl leading-7 font-bold text-t1 bg-transparent border-none outline-none placeholder:text-t3 rounded-sm px-1 -mx-1 my-4.5 tracking-[-0.02em]",
  EntityHeaderEditableTextAreaDetail: /*tw*/ "!text-sm !leading-5 !font-semibold !my-3 !tracking-normal",
  EntityHeaderTitle: /*tw*/ "flex-1 min-w-0 text-xl leading-7 font-bold text-t1 truncate my-4.5 tracking-[-0.02em]",
  EntityHeaderTitleDetail: /*tw*/ "!text-sm !leading-5 !font-semibold !my-3 !tracking-normal",
  EntityHeaderActionsContainer: /*tw*/ "self-start flex items-center gap-0.5 mt-5",
  EntityHeaderActionsContainerDetail: /*tw*/ "!mt-2.5",
  ...
  AIChatPageHeader: /*tw*/ "h-16 flex flex-shrink-0 items-center justify-between bg-bg1 px-10 pr-4",
  AIChatPageHeaderMain: /*tw*/ "flex min-w-0 flex-1 items-center gap-3",
  AIChatPageHeaderIconContainer: /*tw*/ "size-6 flex items-center justify-center text-t2",
  AIChatPageHeaderIconButton: /*tw*/ "size-full flex items-center justify-center",
  AIChatPageHeaderIcon: /*tw*/ "size-6",
  AIChatPageHeaderTitleGroup: /*tw*/ "group flex min-w-0 flex-1 items-center gap-1",
  AIChatPageHeaderTitle: /*tw*/ "truncate text-xl leading-7 font-bold text-t1 tracking-[-0.02em]",
  ...
  SidebarLayoutPaneWrapper: /*tw*/ "bg-bg1 pt-8",

  DragBar: /*tw*/ "fixed top-0 left-0 z-50 h-8 w-screen",
  SidebarLayoutContent: /*tw*/ "h-full overflow-hidden bg-bg1",
  ...
  SidebarViewsContainer: /*tw*/ "flex flex-col mt-3",
  ...
  GuideSectionTitle: /*tw*/ "text-base font-semibold text-t1",
  GuideSectionDescription: /*tw*/ "text-sm leading-6 text-t3",
  GuideListGrid: /*tw*/ "grid grid-cols-1 gap-2 md:grid-cols-2",
  GuideListCard: /*tw*/ "flex items-start gap-3 rounded-xl border border-line-light bg-bg2/60 p-3",
  GuideListIcon: /*tw*/ "flex size-8 shrink-0 items-center justify-center",
  GuideListIconSvg: /*tw*/ "size-5",
  GuideListCardBody: /*tw*/ "min-w-0 flex-1",
  GuideListCardTitle: /*tw*/ "text-sm font-semibold leading-5 text-t1",
  GuideListCardDescription: /*tw*/ "mt-0.5 text-xs leading-5 text-t2",
  GuideHierarchyGrid: /*tw*/ "grid grid-cols-1 gap-2 md:grid-cols-3",
  GuideHierarchyCard: /*tw*/ "rounded-xl border border-line-light p-4",
  GuideHierarchyHeader: /*tw*/ "flex items-center gap-2",
  GuideHierarchyIcon: /*tw*/ "size-4.5 shrink-0",
  GuideHierarchyTitle: /*tw*/ "text-sm font-semibold text-t1",
  GuideHierarchyDescription: /*tw*/ "mt-2 text-xs leading-5 text-t2",
  GuideViewPanel: /*tw*/ "flex items-start gap-3 rounded-xl border border-line-light bg-bg2/60 p-4",
  GuideViewIcon: /*tw*/ "flex size-9 shrink-0 items-center justify-center rounded-lg bg-bg1",
  GuideViewBody: /*tw*/ "min-w-0 flex-1",
  GuideViewTitle: /*tw*/ "text-sm font-semibold text-t1",
  GuideViewDescription: /*tw*/ "mt-1 text-xs leading-5 text-t2",
  GuideViewExamples: /*tw*/ "mt-3 flex flex-wrap gap-1.5",
  GuideViewExample: /*tw*/ "rounded-full border border-line-light bg-bg1 px-2 py-1 text-xs text-t2",
  GuideSteps: /*tw*/ "grid grid-cols-1 gap-2 md:grid-cols-2",
  GuideStep: /*tw*/ "flex gap-3 rounded-lg px-2 py-2",
  GuideStepNumber:
    /*tw*/ "flex size-5 shrink-0 items-center justify-center rounded-full bg-sidebar-active text-xs font-semibold text-t2",
  GuideStepBody: /*tw*/ "min-w-0",
  GuideStepTitle: /*tw*/ "text-sm font-medium text-t1",
  GuideStepDescription: /*tw*/ "mt-0.5 text-xs leading-5 text-t3",
