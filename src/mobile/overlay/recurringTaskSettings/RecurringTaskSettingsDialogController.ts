...
export class RecurringTaskSettingsDialogController implements IDisposable {
  static create(
    ...
    return workbenchOverlayService.createOverlay("dialog", OverlayEnum.mobileRecurringTaskSettings, (options) => {
      const controller = instantiationService.createInstance(
        RecurringTaskSettingsDialogController,
        options,
        defaultConfig,
        onUpdate,
      )
